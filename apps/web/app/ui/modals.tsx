...
import {
  Camera, Check, CircleCheck, Download, Dumbbell, FileText, Film, Link2, MoreHorizontal, Pause,
...
export function WorkoutComposer({ seed, onClose, onSave, onAiGenerate }: { seed?: WorkoutSeed; onClose: () => void; onSave: (record: Record<string, unknown>) => void; onAiGenerate?: () => void }) {
  ...
  const [target, setTarget] = useState("Equipe inteira");
  const [dateTime, setDateTime] = useState("2026-08-29T08:00");
